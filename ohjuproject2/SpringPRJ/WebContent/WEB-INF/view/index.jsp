...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="charts.html">실시간보기</a>
                        <a class="collapse-item" href="charts.html">월간보기</a>
                        <a class="collapse-item" href="charts.html">주간보기</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tables.html">실시간보기</a>
                        <a class="collapse-item" href="tables.html">월간보기</a>
                        <a class="collapse-item" href="tables.html">주간보기</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">이강희님</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <img id="fanImg" class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem; height: 17.5rem;" src="/resource/img/fan.gif" alt="...">
                                </div>
                            </div>
                        </div>
                    </div>
 ...
 <!--    <script src="/resource/vendor/chart.js/Chart.min.js"></script>
    ...
    function changeFan(index) { 
    	if(index==1) {
    		document.getElementById("fanImg").src = "/resource/img/fan.gif";
    	} else if(index==2) {
    		document.getElementById("fanImg").src = "/resource/img/fan.jpg";
    	}
    }
    </script>
    	<script>
